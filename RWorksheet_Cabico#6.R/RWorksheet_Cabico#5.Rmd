...
``` {r num8}
library(readr)
breastcancer_wisconsin <- read_csv("/cloud/project/RWorksheet_Cabico#6.R/breastcancer_wisconsin.csv", show_col_types = FALSE)
...
```{r num9}
library(readr)
abalone <- read_csv("/cloud/project/RWorksheet_Cabico#6.R/abalone.csv")
abalone
head(abalone)
summary(abalone)
```
